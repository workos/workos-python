...
class PipesAccountConnectionDisconnected:
    """Pipes Account Connection Disconnected model."""

    object: Literal["event"]
    """Distinguishes the Event object."""
    id: str
    """Unique identifier for the event."""
    event: Literal["pipes.account_connection.disconnected"]
    ...
    def from_dict(cls, data: dict[str, Any]) -> PipesAccountConnectionDisconnected:
        ...
        try:
            return cls(
                ...
                id=data["id"],
                event=data.get("event", "pipes.account_connection.disconnected"),
            ...
            _raise_deserialize_error("PipesAccountConnectionDisconnected", e)
