...
class PipesAccountConnectionConnected:
    """Pipes Account Connection Connected model."""

    object: Literal["event"]
    """Distinguishes the Event object."""
    id: str
    """Unique identifier for the event."""
    event: Literal["pipes.account_connection.connected"]
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> PipesAccountConnectionConnected:
        """Deserialize from a dictionary."""
        try:
            return cls(
                object=data.get("object", "event"),
                id=data["id"],
                event=data.get("event", "pipes.account_connection.connected"),
            ...
            _raise_deserialize_error("PipesAccountConnectionConnected", e)
