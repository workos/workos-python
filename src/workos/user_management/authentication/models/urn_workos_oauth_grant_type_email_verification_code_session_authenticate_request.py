...
class UrnWorkOSOAuthGrantTypeEmailVerificationCodeSessionAuthenticateRequest:
    """Urn Work OSO Auth Grant Type Email Verification Code Session Authenticate Request model."""
    ...
    def from_dict(
        ...
        try:
            ...
            raise BaseRequestException(
                f"Unexpected API response while parsing UrnWorkOSOAuthGrantTypeEmailVerificationCodeSessionAuthenticateRequest: {e!s}"
            ) from e
