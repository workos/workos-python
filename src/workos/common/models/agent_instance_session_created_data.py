...
class AgentInstanceSessionCreatedData:
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> AgentInstanceSessionCreatedData:
        ...
        try:
            ...
            _raise_deserialize_error("AgentInstanceSessionCreatedData", e)
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result["permission_slugs"] = self.permission_slugs
        return result
