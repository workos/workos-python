...
from .invitation_created_context import InvitationCreatedContext
from .invitation_created_data import InvitationCreatedData


@dataclass(slots=True)
class InvitationCreated:
    """Invitation Created model."""
    ...
    context: Optional["InvitationCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "InvitationCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=InvitationCreatedContext.from_dict(cast(Dict[str, Any], _v))
