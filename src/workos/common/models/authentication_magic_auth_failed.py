...
class AuthenticationMagicAuthFailed:
    """Authentication Magic Auth Failed model."""
    ...
    context: Optional["AuthenticationMagicAuthFailedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationMagicAuthFailed":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationMagicAuthFailedContext.from_dict(
