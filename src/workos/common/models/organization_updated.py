...
from .organization_updated_context import OrganizationUpdatedContext
from .organization_updated_data import OrganizationUpdatedData


@dataclass(slots=True)
class OrganizationUpdated:
    """Organization Updated model."""
    ...
    context: Optional["OrganizationUpdatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationUpdated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationUpdatedContext.from_dict(cast(Dict[str, Any], _v))
