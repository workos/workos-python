...
from .organization_created_context import OrganizationCreatedContext
from .organization_created_data import OrganizationCreatedData


@dataclass(slots=True)
class OrganizationCreated:
    """Organization Created model."""
    ...
    context: Optional["OrganizationCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationCreatedContext.from_dict(cast(Dict[str, Any], _v))
