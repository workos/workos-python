...
class WorkOSAuthenticationResponse(WorkOSBaseResource):
    ...
    def construct_from_response(cls, response):
        authentication_response = super(WorkOSAuthenticationResponse, cls).construct_from_response(response)
    ...
    def to_dict(self):
        authentication_response_dict = super(WorkOSAuthenticationResponse, self).to_dict()
