...
from .vault_data_created_context import VaultDataCreatedContext
from .vault_data_created_data import VaultDataCreatedData


@dataclass(slots=True)
class VaultDataCreated:
    """Vault Data Created model."""
    ...
    context: Optional["VaultDataCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "VaultDataCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=VaultDataCreatedContext.from_dict(cast(Dict[str, Any], _v))
