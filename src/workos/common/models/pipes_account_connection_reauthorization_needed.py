...
class PipesAccountConnectionReauthorizationNeeded:
    """Pipes Account Connection Reauthorization Needed model."""

    object: Literal["event"]
    """Distinguishes the Event object."""
    id: str
    """Unique identifier for the event."""
    event: Literal["pipes.account_connection.reauthorization_needed"]
    ...
    def from_dict(
        ...
        try:
            ...
            _raise_deserialize_error("PipesAccountConnectionReauthorizationNeeded", e)
