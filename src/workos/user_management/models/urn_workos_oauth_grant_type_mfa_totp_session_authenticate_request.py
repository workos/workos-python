...
class UrnWorkOSOAuthGrantTypeMFATotpSessionAuthenticateRequest:
    """Urn Work OSO Auth Grant Type MFA Totp Session Authenticate Request model."""
    ...
    def from_dict(
        ...
        try:
            return cls(
                ...
                authentication_challenge_id=data["authentication_challenge_id"],
            ...
            raise WorkOSError(
                f"Unexpected API response while parsing UrnWorkOSOAuthGrantTypeMFATotpSessionAuthenticateRequest: {e!s}"
            ) from e
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result["authentication_challenge_id"] = self.authentication_challenge_id
