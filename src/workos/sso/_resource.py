...
class SSO:
    ...
    def get_authorization_url(
        ...
        *,
        ...
        prompt: Optional[Literal["login"]] = None,
        request_options: Optional[RequestOptions] = None,
    ) -> str:
        """Initiate SSO
        ...
        Args:
            ...
            prompt: If set to `login`, forces re-authentication at the identity provider. For SAML connections this sets `ForceAuthn="true"` in the SAML request.
            request_options: Per-request options. Supports extra_headers, timeout, max_retries, and base_url override.
