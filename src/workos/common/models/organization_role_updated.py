...
from .organization_role_updated_context import OrganizationRoleUpdatedContext
from .organization_role_updated_data import OrganizationRoleUpdatedData


@dataclass(slots=True)
class OrganizationRoleUpdated:
    """Organization Role Updated model."""
    ...
    context: Optional["OrganizationRoleUpdatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationRoleUpdated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationRoleUpdatedContext.from_dict(
