...
class MFATotpSessionAuthenticateRequest:
    """MFA Totp Session Authenticate Request model."""
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "MFATotpSessionAuthenticateRequest":
        ...
        try:
            ...
            _raise_deserialize_error("MFATotpSessionAuthenticateRequest", e)
