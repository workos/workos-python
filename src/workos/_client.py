...
class WorkOSClient(_SyncBase):
    ...
    @functools.cached_property
    def user_management_organization_membership_groups(self) -> UserManagementOrganizationMembershipGroups:
...
class AsyncWorkOSClient(_AsyncBase):
    ...
    @functools.cached_property
    def user_management_organization_membership_groups(self) -> AsyncUserManagementOrganizationMembershipGroups:
        """User Management Organization Membership Groups API resources."""
