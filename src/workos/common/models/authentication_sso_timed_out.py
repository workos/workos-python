...
from .authentication_sso_timed_out_context import AuthenticationSSOTimedOutContext
from .authentication_sso_timed_out_data import AuthenticationSSOTimedOutData


@dataclass(slots=True)
class AuthenticationSSOTimedOut:
    """Authentication SSO Timed Out model."""
    ...
    context: Optional["AuthenticationSSOTimedOutContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationSSOTimedOut":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationSSOTimedOutContext.from_dict(
