...
from .authentication_sso_succeeded_context import AuthenticationSSOSucceededContext
from .authentication_sso_succeeded_data import AuthenticationSSOSucceededData


@dataclass(slots=True)
class AuthenticationSSOSucceeded:
    """Authentication SSO Succeeded model."""
    ...
    context: Optional["AuthenticationSSOSucceededContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationSSOSucceeded":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationSSOSucceededContext.from_dict(
