...
class TestUsers(object):
    ...
    def test_authenticate_with_magic_auth(self, capture_and_mock_request, mock_auth_response):
        code = "test_auth"
        expires_in = 3600
        ...
        response = self.users.authenticate_with_magic_auth(code=code,
        ...
        assert request["json"]["grant_type"] == "urn:workos:oauth:grant-type:magic-auth:code"
