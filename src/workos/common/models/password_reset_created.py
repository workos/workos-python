...
from .password_reset_created_context import PasswordResetCreatedContext
...
class PasswordResetCreated:
    ...
    context: Optional["PasswordResetCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PasswordResetCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=PasswordResetCreatedContext.from_dict(cast(Dict[str, Any], _v))
