...
class Webhooks(object):
    ...
    def verify_event(
        ...
        if payload is None:
            raise ValueError(
                "Payload body is missing and is a required parameter")
        elif sig_header is None:
            raise ValueError(
                "Payload signature missing and is a required parameter")
        elif secret is None:
...
class WebhookSignature(object):
    ...
    def verify_header(event_body, event_signature, secret, tolerance=None):
        ...
        WebhookSignature.check_timstamp_range(
        ...
        WebhookSignature.constant_time_compare(
