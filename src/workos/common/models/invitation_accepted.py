...
from .invitation_accepted_context import InvitationAcceptedContext
...
class InvitationAccepted:
    ...
    context: Optional["InvitationAcceptedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "InvitationAccepted":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=InvitationAcceptedContext.from_dict(cast(Dict[str, Any], _v))
