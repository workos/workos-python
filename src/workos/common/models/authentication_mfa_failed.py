...
from .authentication_mfa_failed_context import AuthenticationMFAFailedContext
from .authentication_mfa_failed_data import AuthenticationMFAFailedData


@dataclass(slots=True)
class AuthenticationMFAFailed:
    """Authentication MFA Failed model."""
    ...
    context: Optional["AuthenticationMFAFailedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationMFAFailed":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationMFAFailedContext.from_dict(
