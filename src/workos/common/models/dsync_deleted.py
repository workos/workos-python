...
from .dsync_deleted_context import DsyncDeletedContext
...
class DsyncDeleted:
    ...
    context: Optional["DsyncDeletedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DsyncDeleted":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=DsyncDeletedContext.from_dict(cast(Dict[str, Any], _v))
