...
from .password_reset_succeeded_context import PasswordResetSucceededContext
...
class PasswordResetSucceeded:
    ...
    context: Optional["PasswordResetSucceededContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PasswordResetSucceeded":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=PasswordResetSucceededContext.from_dict(
