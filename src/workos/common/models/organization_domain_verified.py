...
from .organization_domain_verified_context import OrganizationDomainVerifiedContext
...
class OrganizationDomainVerified:
    ...
    context: Optional["OrganizationDomainVerifiedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationDomainVerified":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationDomainVerifiedContext.from_dict(
