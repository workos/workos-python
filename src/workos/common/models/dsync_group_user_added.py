...
from .dsync_group_user_added_context import DsyncGroupUserAddedContext
from .dsync_group_user_added_data import DsyncGroupUserAddedData


@dataclass(slots=True)
class DsyncGroupUserAdded:
    """Dsync Group User Added model."""
    ...
    context: Optional["DsyncGroupUserAddedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DsyncGroupUserAdded":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=DsyncGroupUserAddedContext.from_dict(cast(Dict[str, Any], _v))
