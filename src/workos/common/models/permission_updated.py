...
from .permission_updated_context import PermissionUpdatedContext
from .permission_updated_data import PermissionUpdatedData


@dataclass(slots=True)
class PermissionUpdated:
    """Permission Updated model."""
    ...
    context: Optional["PermissionUpdatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PermissionUpdated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=PermissionUpdatedContext.from_dict(cast(Dict[str, Any], _v))
