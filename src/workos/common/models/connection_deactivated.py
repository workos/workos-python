...
from .connection_deactivated_context import ConnectionDeactivatedContext
...
class ConnectionDeactivated:
    ...
    context: Optional["ConnectionDeactivatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ConnectionDeactivated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=ConnectionDeactivatedContext.from_dict(cast(Dict[str, Any], _v))
