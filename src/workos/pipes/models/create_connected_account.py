...
class CreateConnectedAccount:
    ...
    state: CreateConnectedAccountState | None = None
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> CreateConnectedAccount:
        ...
        try:
            return cls(
                ...
                state=CreateConnectedAccountState(_v_state)
                if (_v_state := data.get("state")) is not None
                else None,
                connection_intent=data.get("connection_intent"),
            )
        except (KeyError, ValueError) as e:
            _raise_deserialize_error("CreateConnectedAccount", e)
