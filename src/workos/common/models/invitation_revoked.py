...
from .invitation_revoked_context import InvitationRevokedContext
from .invitation_revoked_data import InvitationRevokedData


@dataclass(slots=True)
class InvitationRevoked:
    """Invitation Revoked model."""
    ...
    context: Optional["InvitationRevokedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "InvitationRevoked":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=InvitationRevokedContext.from_dict(cast(Dict[str, Any], _v))
