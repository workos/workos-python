...
from .api_key_revoked_context import ApiKeyRevokedContext
from .api_key_revoked_data import ApiKeyRevokedData


@dataclass(slots=True)
class ApiKeyRevoked:
    """Api Key Revoked model."""
    ...
    context: Optional["ApiKeyRevokedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ApiKeyRevoked":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=ApiKeyRevokedContext.from_dict(cast(Dict[str, Any], _v))
