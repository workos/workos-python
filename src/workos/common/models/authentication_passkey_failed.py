...
from .authentication_passkey_failed_context import AuthenticationPasskeyFailedContext
from .authentication_passkey_failed_data import AuthenticationPasskeyFailedData


@dataclass(slots=True)
class AuthenticationPasskeyFailed:
    """Authentication Passkey Failed model."""
    ...
    context: Optional["AuthenticationPasskeyFailedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationPasskeyFailed":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationPasskeyFailedContext.from_dict(
