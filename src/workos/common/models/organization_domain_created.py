...
from .organization_domain_created_context import OrganizationDomainCreatedContext
from .organization_domain_created_data import OrganizationDomainCreatedData


@dataclass(slots=True)
class OrganizationDomainCreated:
    """Organization Domain Created model."""
    ...
    context: Optional["OrganizationDomainCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationDomainCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationDomainCreatedContext.from_dict(
