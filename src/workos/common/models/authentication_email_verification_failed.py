...
from .authentication_email_verification_failed_data import AuthenticationEmailVerificationFailedData
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationEmailVerificationFailed":
        ...
        try:
            return cls(
                id=data["id"],
                event=data["event"],
                data=AuthenticationEmailVerificationFailedData.from_dict(cast(Dict[str, Any], data["data"])),
