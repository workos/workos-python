...
from .dsync_group_user_removed_context import DsyncGroupUserRemovedContext
...
class DsyncGroupUserRemoved:
    ...
    context: Optional["DsyncGroupUserRemovedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DsyncGroupUserRemoved":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=DsyncGroupUserRemovedContext.from_dict(cast(Dict[str, Any], _v))
