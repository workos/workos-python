...
class AuthenticationPasswordSucceeded:
    """Authentication Password Succeeded model."""
    ...
    context: Optional["AuthenticationPasswordSucceededContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationPasswordSucceeded":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationPasswordSucceededContext.from_dict(
