...
from .organization_role_deleted_context import OrganizationRoleDeletedContext
from .organization_role_deleted_data import OrganizationRoleDeletedData


@dataclass(slots=True)
class OrganizationRoleDeleted:
    """Organization Role Deleted model."""
    ...
    context: Optional["OrganizationRoleDeletedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "OrganizationRoleDeleted":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=OrganizationRoleDeletedContext.from_dict(
