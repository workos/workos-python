...
class TestWebhooks(object):
    ...
    def test_enroll_factor_totp_success(
        ...
        enroll_factor = self.mfa.enroll_factor("totp", "testytest", "berniesanders", None)
    ...
    def test_challenge_success(
        ...
        challenge_factor = self.mfa.challenge_factor("auth_factor_01FXNWW32G7F3MG8MYK5D1HJJM")
    ...
    def test_verify_success(
        ...
        verify_factor = self.mfa.verify_factor("auth_challenge_01FXNXH8Y2K3YVWJ10P139A6DT", '093647')
