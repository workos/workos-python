...
from .vault_names_listed_context import VaultNamesListedContext
from .vault_names_listed_data import VaultNamesListedData


@dataclass(slots=True)
class VaultNamesListed:
    """Vault Names Listed model."""
    ...
    context: Optional["VaultNamesListedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "VaultNamesListed":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=VaultNamesListedContext.from_dict(cast(Dict[str, Any], _v))
