...
class AuthenticationRadarRiskDetected:
    """Authentication Radar Risk Detected model."""
    ...
    context: Optional["AuthenticationRadarRiskDetectedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationRadarRiskDetected":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationRadarRiskDetectedContext.from_dict(
