...
from .connection_deleted_context import ConnectionDeletedContext
from .connection_deleted_data import ConnectionDeletedData


@dataclass(slots=True)
class ConnectionDeleted:
    """Connection Deleted model."""
    ...
    context: Optional["ConnectionDeletedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ConnectionDeleted":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=ConnectionDeletedContext.from_dict(cast(Dict[str, Any], _v))
