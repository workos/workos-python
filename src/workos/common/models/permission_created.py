...
from .permission_created_context import PermissionCreatedContext
from .permission_created_data import PermissionCreatedData


@dataclass(slots=True)
class PermissionCreated:
    """Permission Created model."""
    ...
    context: Optional["PermissionCreatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "PermissionCreated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=PermissionCreatedContext.from_dict(cast(Dict[str, Any], _v))
