...
from .dsync_activated_context import DsyncActivatedContext
from .dsync_activated_data import DsyncActivatedData


@dataclass(slots=True)
class DsyncActivated:
    """Dsync Activated model."""
    ...
    context: Optional["DsyncActivatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DsyncActivated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=DsyncActivatedContext.from_dict(cast(Dict[str, Any], _v))
