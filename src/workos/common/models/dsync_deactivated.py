...
from .dsync_deactivated_context import DsyncDeactivatedContext
...
class DsyncDeactivated:
    ...
    context: Optional["DsyncDeactivatedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "DsyncDeactivated":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=DsyncDeactivatedContext.from_dict(cast(Dict[str, Any], _v))
