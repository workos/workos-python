...
from .vault_dek_read_context import VaultDekReadContext
from .vault_dek_read_data import VaultDekReadData


@dataclass(slots=True)
class VaultDekRead:
    """Vault Dek Read model."""
    ...
    context: Optional["VaultDekReadContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "VaultDekRead":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=VaultDekReadContext.from_dict(cast(Dict[str, Any], _v))
