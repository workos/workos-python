...
from .action_user_registration_denied_context import ActionUserRegistrationDeniedContext
from .action_user_registration_denied_data import ActionUserRegistrationDeniedData


@dataclass(slots=True)
class ActionUserRegistrationDenied:
    """Action User Registration Denied model."""
    ...
    context: Optional["ActionUserRegistrationDeniedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ActionUserRegistrationDenied":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=ActionUserRegistrationDeniedContext.from_dict(
