...
from .authentication_sso_started_context import AuthenticationSSOStartedContext
from .authentication_sso_started_data import AuthenticationSSOStartedData


@dataclass(slots=True)
class AuthenticationSSOStarted:
    """Authentication SSO Started model."""
    ...
    context: Optional["AuthenticationSSOStartedContext"] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "AuthenticationSSOStarted":
        ...
        try:
            return cls(
                ...
                object=data["object"],
                context=AuthenticationSSOStartedContext.from_dict(
